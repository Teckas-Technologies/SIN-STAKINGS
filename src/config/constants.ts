export const NEXT_PUBLIC_NETWORK = "mainnet";
export const SIN_STAKING_CONTRACT = "sin-ft-staking.near";
export const SIN_STAKING_CONTRACT_BALANCE = "sin-339.meme-cooking.near";
